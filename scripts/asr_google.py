...
#    dic=os.path.join("/home/"+os.environ.get('USER')+"/Dropbox/@Home", 'doris.dict')
#)
...
class PorcupineDemo(Thread):
    ...
    def stt(self):
        ...
        try:
            return String(rec.recognize_google(audio))
        except:
            return "-------"
...
def _default_library_path():
    ...
    return os.path.join(os.path.dirname(__file__), '/home/'+os.environ.get('USER')+'/catkin_ws/src/ASR_Doris/scripts/lib/linux/%s/libpv_porcupine.so' % machine)
    
if __name__ == '__main__':
    parser = argparse.ArgumentParser()

    parser.add_argument('--keyword_file_paths', help='comma-separated absolute paths to keyword files', type=str, default="/home/"+os.environ.get('USER')+"/catkin_ws/src/ASR_Doris/scripts/hello doris_linux.ppn")
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(os.path.dirname(__file__), '/home/'+os.environ.get('USER')+'/catkin_ws/src/ASR_Doris/scripts/lib/common/porcupine_params.pv'))
